...
export const IDLE_COLOR = '#4D6BFE'
export const PEAK_COLOR = '#D92D20'
 ...
 */
export function formatRemainingTime(durationMs) {
 ...
 */
export function getDeepSeekTimeState(instant = Date.now()) {
